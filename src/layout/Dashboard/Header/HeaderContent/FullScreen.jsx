...
// assets
import { Maximize1, LayoutMaximize } from 'iconsax-react';
...
export default function FullScreen() {
  ...
  return (
    <Box sx={{ flexShrink: 0, ml: 182, display: 'none' }}>
      <Tooltip title={open ? 'Tam Ekrandan Çık' : 'Tam Ekran'}>
        ...
        >
          <LayoutMaximize variant="Bulk" {...(open && { style: { transform: 'rotate(180deg)' } })} />
        </IconButton>
      </Tooltip>
    </Box>
  );

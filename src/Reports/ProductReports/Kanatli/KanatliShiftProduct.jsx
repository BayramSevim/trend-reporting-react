...
import MasterDetail from 'components/MasterDetail/ShiftProduct/Kanatli/MasterDetail';
...
import ProductCumShiftChart from 'components/charts/Kanatli/ProductCumShiftChart';
      ...
      >
        <Grid item height={200} display="flex" alignItems="center">
          <Typography variant="h1" sx={{ fontWeight: '800' }}>
            Kanatlı-1 Vardiya Bazlı Üretim Raporu
          </Typography>
        </Grid>
        <Grid item>
          <ShiftSelection

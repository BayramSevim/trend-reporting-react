...
import MasterDetail from 'components/MasterDetail/GroupByProduct/Buyukbas/MasterDetail';
...
import GroupByProductChart from 'components/charts/Buyukbas/GroupByProductChart';
      ...
      >
        <Grid item height={200} display="flex" alignItems="center">
          <Typography variant="h1" sx={{ fontWeight: '800' }}>
            Büyükbaş Grup Bazlı Üretim Raporu
          </Typography>
        </Grid>
        <Grid item>
          <ProductSelection

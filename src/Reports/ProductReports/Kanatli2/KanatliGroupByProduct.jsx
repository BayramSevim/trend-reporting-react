...
import MasterDetail from 'components/MasterDetail/GroupByProduct/Kanatli2/MasterDetail';
...
import GroupByProductChart from 'components/charts/Kanatli2/GroupByProductChart';
      ...
      >
        <Grid item height={200} display="flex" alignItems="center">
          <Typography variant="h1" sx={{ fontWeight: '800' }}>
            Kanatlı-2 Grup Bazlı Üretim Raporu
          </Typography>
        </Grid>
        <Grid item>
          <ProductSelection

...
import MasterDetail from '../../components/MasterDetail/Mudahale/MasterDetail';
...
const MudahaleReport = () => {
  ...
  const fetchProduct = async () => {
    await axios
      .get(`${GetAPIUrl()}/api/Product/GetMudahaleHistoryByDate`, {
        params: {
          dateS: selectedDateS,
          dateF: selectedDateF
        }

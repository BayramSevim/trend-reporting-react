...
import MasterDetail from '../../components/MasterDetail/Extruder/Transfer/MasterDetail';
...
const ExtruderTransfer = () => {
  ...
  const fetchProduct = async () => {
    await axios
      .get(`${GetAPIUrl()}/api/Vakum/GetExtruderActHistory`, {
        params: {
          dateS: selectedDateS,
          dateF: selectedDateF
        }
...
export default ExtruderTransfer;

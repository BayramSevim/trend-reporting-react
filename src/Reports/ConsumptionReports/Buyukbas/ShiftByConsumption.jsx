...
import MasterDetail from 'components/MasterDetail/ShiftConsumption/Buyukbas/MasterDetail';
...
import ShiftConsumptionChart from 'components/charts/Buyukbas/ShiftConsumption/ShiftConsumptionChart';
      ...
      >
        <Grid item height={200} display="flex" alignItems="center">
          <Typography variant="h1" sx={{ fontWeight: '800' }}>
            Büyükbaş Vardiya Bazlı Tüketim Raporu
          </Typography>
        </Grid>
        <Grid item>
          <ShiftSelection

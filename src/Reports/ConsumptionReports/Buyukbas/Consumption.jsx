...
import MasterDetail from 'components/MasterDetail/Consumption/Buyukbas/MasterDetail';
...
import ConsumeChart from 'components/charts/Buyukbas/Consumption/ConsumptionChart';
...
const Consumption = () => {
  ...
  const getProductId = async () => {
    await axios
      .get(`${GetAPIUrl()}/api/Product/GetRawMaterialFilters`)
      .then((res) => {
        const data = decompressedData(res.data);
        setGetProduct(data);
      })

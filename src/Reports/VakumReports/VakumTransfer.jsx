...
import MasterDetail from '../../components/MasterDetail/Vakum/Transfer/MasterDetail';
...
const VakumTransfer = () => {
  ...
  const fetchProduct = async () => {
    await axios
      .get(`${GetAPIUrl()}/api/Vakum/GetVakumActHistory`, {
        params: {
          dateS: selectedDateS,
          dateF: selectedDateF
        }

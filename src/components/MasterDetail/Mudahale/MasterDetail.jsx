...
const App = ({ dateS, dateF, isUpdate }) => {
  ...
  useEffect(() => {
    const url = `${GetAPIUrl()}/api/Product/GetMudahaleHistoryByDate?dateS=${formattedDateS}&dateF=${formattedDateF}`;
  ...
  return (
    ...
    >
      ...
      <Column dataField="EquipmentName" caption="Ekipman Adı" alignment="center" />
      <Column dataField="LogDate" dataType="date" caption="Tarih" alignment="center" format="dd.MM.yyyy HH.mm" />
      <Column dataField="Comment" caption="İşlem" alignment="center" />
      <Summary>
        <TotalItem showInColumn="EquipmentName" summaryType="count" />
      </Summary>
    </DataGrid>
  );
};

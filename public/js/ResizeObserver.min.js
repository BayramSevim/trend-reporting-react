  ...
  function c(t) {
    ...
    if (
      ('border-box' === i.boxSizing &&
        (Math.round(a + s) !== e && (a -= l(i, 'left', 'right') + s), Math.round(h + c) !== n && (h -= l(i, 'top', 'bottom') + c)),
    ...
    y = function (t, e) {
      var n,
        ...
        h =
          ...
          u(a, { x: r, y: i, width: o, height: s, top: i, right: r + o, bottom: s + i, left: r }),
          a);
